...
NotebookDataLength[    182546,       3846]
NotebookOptionsPosition[    155834,       3267]
NotebookOutlinePosition[    182144,       3829]
CellTagsIndexPosition[    182031,       3823]
WindowTitle->Solving the 1D Helmholtz Differential Equation Using Finite \
Differences
WindowFrame->Normal*)
...
$CellContext`u], $CellContext`padIt3[
          ...
          Pattern[$CellContext`f, 
           Blank[List]]] := 
        AccountingForm[$CellContext`v, $CellContext`f, 
          NumberSigns -> {"", ""}, NumberPadding -> {"0", "0"}, SignPadding -> 
          True, NumberPoint -> 
...
$CellContext`from, $CellContext`to}, 
        ...
        Attributes[Subscript] = {
         NHoldRest}, $CellContext`forceTermUsedFormat1D[
          Pattern[$CellContext`forceTermSelection, 
           Blank[]], 
          Pattern[$CellContext`aa, 
           Blank[]], 
...
$CellContext`forceTermSelection == 
      ...
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{($CellContext`checkTerm[
             PatternTest[
              Pattern[$CellContext`t, 
               Blank[]], NumberQ[#]& ]] := 
           If[Abs[$CellContext`t - 1] < $MachineEpsilon, 1, 
             If[Abs[$CellContext`t] < $MachineEpsilon, 0, $CellContext`t]]; 
          Null) ($CellContext`generatePhysicalCoordinates1D[
             PatternTest[
              Pattern[$CellContext`h, 
               Blank[]], And[
               Element[#, Reals], 
             ...
             PatternTest[
              Pattern[$CellContext`centerGrid, 
               Blank[]], Element[#, Booleans]& ]] := 
           Module[{$CellContext`i, $CellContext`nodes, \
...
-($CellContext`nodes/2) + 1, $CellContext`nodes/2, 
               ...
               Table[$CellContext`h $CellContext`i, {$CellContext`i, 
                 0, $CellContext`intervals, 1}]]]; 
          Null) ($CellContext`forceTermUsedFormat1D[
             Pattern[$CellContext`forceTermSelection, 
              Blank[]], 
             Pattern[$CellContext`aa, 
              Blank[]], 
...
$CellContext`checkTerm[$CellContext`nn0]}, 
             ...
             Which[$CellContext`forceTermSelection == 
              ...
              2, $CellContext`a $CellContext`x^$CellContext`n0, \
$CellContext`forceTermSelection == 
              3, $CellContext`a (1/($CellContext`stdx 
               HoldForm[(2 Pi)^Rational[1, 2]])) 
              Exp[(-($CellContext`x - $CellContext`x0)^2)/(
                2 $CellContext`stdx^2)], $CellContext`forceTermSelection == 
              4, $CellContext`a 
              Cos[$CellContext`b HoldForm[Pi $CellContext`x]]]]; 
          Null) ($CellContext`makeScrolledPane[
             PatternTest[
              Pattern[$CellContext`mat, 
               Blank[]], MatrixQ[#, NumberQ]& ], 
             PatternTest[
           ...
           Module[{$CellContext`t}, $CellContext`t = 
             ...
             Pane[$CellContext`t, 
               ...
               Scrollbars -> True]]; Null) ($CellContext`makeScrolledPane[
             PatternTest[
              Pattern[$CellContext`lst, 
               Blank[]], VectorQ[#, NumericQ]& ], 
             PatternTest[
             ...
             PatternTest[
              Pattern[$CellContext`nCol, 
               ...
               Positive[#]]& ]] := 
           Module[{$CellContext`t}, $CellContext`t = 
              Grid[{$CellContext`lst}, Spacings -> {0.4, 0.4}, Alignment -> 
                Left, Frame -> All]; $CellContext`t = Text[
                Style[
                 AccountingForm[
                  Chop[
             ...
             Pane[$CellContext`t, 
               ImageSize -> {$CellContext`nCol, $CellContext`nRow}, 
               Scrollbars -> True]]; Null) ($CellContext`process[
             Pattern[$CellContext`h, 
              Blank[]], 
             Pattern[$CellContext`centerGrid, 
              Blank[]], 
...
$CellContext`forceVector, $CellContext`westBCtype, $CellContext`eastBCtype], \
$CellContext`AA, $CellContext`grid, $CellContext`plotToShow, \
$CellContext`showGridLines]]; Null) ($CellContext`solve[
             Pattern[$CellContext`$u, 
              Blank[]], 
             Pattern[$CellContext`AA, 
              Blank[]], 
             ...
             Pattern[$CellContext`eastBCtype, 
              Blank[]]] := Module[{$CellContext`u = $CellContext`$u}, Which[
               ...
               Part[$CellContext`u, 
                 Span[2, -2]] = 
               LinearSolve[$CellContext`AA, $CellContext`forceVector]]; \
$CellContext`u]; Null) ($CellContext`initializeSystem[
             Pattern[$CellContext`h, 
              Blank[]], 
             Pattern[$CellContext`length, 
              Blank[]], 
...
$CellContext`h, $CellContext`forceGrid, $CellContext`u]; {$CellContext`grid, \
$CellContext`forceGrid, $CellContext`u, $CellContext`AA, \
$CellContext`forceVector}]; Null) ($CellContext`makeForceGrid[
             Pattern[$CellContext`a, 
              Blank[]], 
             Pattern[$CellContext`b, 
              Blank[]], 
             ...
             Pattern[$CellContext`grid, 
              Blank[]]] := 
           Module[{$CellContext`n0 = \
$CellContext`checkTerm[$CellContext`n0$], $CellContext`i}, 
             Which[$CellContext`forceTermSelection == 1, 
...
$CellContext`forceTermSelection == 4, 
              ...
              Table[$CellContext`a 
               Cos[$CellContext`b Pi 
                 Part[$CellContext`grid, $CellContext`i]], {$CellContext`i, \
$CellContext`n}]]]; Null) ($CellContext`makeSystemAndRightHandSideVector[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`westBCtype, 
              Blank[]], 
               ...
               Part[$CellContext`forceVector, -1] = $CellContext`h^2 
                 ...
                 Part[$CellContext`u, -1]; Part[$CellContext`forceVector, 
                  Span[2, -2]] = $CellContext`h^2 Part[$CellContext`forceGrid, 
                   Span[
                   3, -3]]]; {$CellContext`AA, $CellContext`forceVector}]; 
          Null) ($CellContext`setBoundaryConditions[
             Pattern[$CellContext`$u, 
              Blank[]], 
             Pattern[$CellContext`grid, 
              Blank[]], 
...
$CellContext`eastbc[
                  Part[$CellContext`grid, -1]]]; $CellContext`u]; 
          Null) ($CellContext`getNDsolveResult[
             Pattern[$CellContext`k, 
              Blank[]], 
             Pattern[$CellContext`westBCtype, 
              Blank[]], 
                ...
                First[
                 Quiet[
                  NDSolve[
                   ...
                   Flatten[{$CellContext`eq, \
$CellContext`boundaryConditions}], $CellContext`y, {$CellContext`x, \
$CellContext`from, $CellContext`to}, MaxSteps -> Infinity]]]]; 
             If[$CellContext`showGridLines, 
               Framed[
                Plot[
                 Re[
                  $CellContext`sol[$CellContext`x]], {$CellContext`x, \
...
$CellContext`from, $CellContext`to}, 
                 Evaluate[$CellContext`plotOptions]], FrameStyle -> Directive[
                  Thickness[0.005], Gray]]]]; 
          Null) ($CellContext`makeFinalPlot[
             Pattern[$CellContext`u, 
              Blank[]], 
             Pattern[$CellContext`AA, 
              Blank[]], 
...
$CellContext`makeScrolledPane[
                 Normal[$CellContext`u], $CellContext`ContentSizeH - 
                 350, $CellContext`ContentSizeW - 
                 20], $CellContext`plotToShow == "system matrix information", 
               
               Block[{$CellContext`tmp, $CellContext`dim, $CellContext`m, \
$CellContext`cond}, $CellContext`cond = Part[
                   LUDecomposition[
                    Normal[$CellContext`AA]], 3]; $CellContext`dim = 
                 Dimensions[
                   Normal[$CellContext`AA]]; $CellContext`m = Min[20, 
                   First[$CellContext`dim]]; $CellContext`finalDisplayImage = 
                 Grid[{{
...
$CellContext`divglobal}]; If[Length[$CellContext`divglobal] == 1, 
              ...
              MapIndexed[ReplaceAll[# - Part[#2, 1] + 1 -> Dividers, 
               ...
               Dividers -> $CellContext`divglobal, $CellContext`opts]]; 
          Null) (MakeBoxes[
             Derivative[
                 ...
                 Thread[
                  $CellContext`dummyhead[{$CellContext`vars}, 
                   ...
                   Partition[{$CellContext`indices}, 
                    1]]], $CellContext`dummyhead -> Table]]]]]; 
          Null) ($CellContext`ContentSizeW = 295; 
          Null) ($CellContext`ContentSizeH = 415; Null) ($CellContext`padIt1[
             PatternTest[
              Pattern[$CellContext`v, 
               Blank[]], And[
               NumericQ[#], Im[#] == 0]& ], 
          ...
          Null) ($CellContext`padIt3[
           ...
           AccountingForm[$CellContext`v, $CellContext`f, 
             ...
             SignPadding -> True, NumberPoint -> 
             If[Part[$CellContext`f, 2] == 0, "", "."]]; Null)}]]; 
...
Cell[TextData[{
 ButtonBox["Helmholtz Differential Equation",
  BaseStyle->"Hyperlink",
  ButtonData->{
...
SolvingThe1DHelmholtzDifferentialEquationUsingFiniteDifferen&version=0008"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
SolvingThe1DHelmholtzDifferentialEquationUsingFiniteDifferen/\
SolvingThe1DHelmholtzDifferentialEquationUsingFiniteDifferen-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Solving the 1D Helmholtz Differential Equation Using Finite \
Differences",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
SolvingThe1DHelmholtzDifferentialEquationUsingFiniteDifferen/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
SolvingThe1DHelmholtzDifferentialEquationUsingFiniteDifferen/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[138324, 2810, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[138585, 2819, 4440, 96, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[155012, 3242, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 181739, 3812},
 {"Copyright", 181938, 3817}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1322, 32, 34328, 567, 70, "DemonstrationHeader"],
Cell[35653, 601, 100, 2, 70, "DemoTitle"],
Cell[35756, 605, 101396, 2173, 70, "Output",
 CellID->1954172264],
Cell[137155, 2780, 1166, 28, 70, "ManipulateCaption"],
Cell[138324, 2810, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[138585, 2819, 4440, 96, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[143028, 2917, 33, 0, 70, "DetailsSection"],
Cell[143064, 2919, 1362, 38, 70, "DetailNotes",
 CellID->232398131],
Cell[144429, 2959, 1488, 43, 70, "DetailNotes",
 CellID->99152329],
Cell[145920, 3004, 1453, 53, 70, "DetailNotes",
 CellID->282786142],
Cell[147376, 3059, 53, 1, 70, "DetailNotes",
 CellID->2133992110],
Cell[147432, 3062, 346, 10, 70, "DetailNotes",
 CellID->239642231],
Cell[147781, 3074, 44, 0, 70, "RelatedLinksSection"],
Cell[147828, 3076, 690, 23, 70, "RelatedLinks",
 CellID->140929062],
Cell[148521, 3101, 4928, 92, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[153452, 3195, 45, 0, 70, "CitationSection"],
Cell[153500, 3197, 344, 10, 70, "Author"],
Cell[153847, 3209, 1162, 31, 70, "Citations"],
Cell[155012, 3242, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature tSq4US4EJd85pwmyuyQU3#0D *)
